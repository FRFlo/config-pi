...
The extension ships in the global extensions folder and is **enabled by default per session**.
Use the gate when you want to disable it for a specific session.
